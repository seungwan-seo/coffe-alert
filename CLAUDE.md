...
## 매물 평가 기준
[STRATEGY.md](STRATEGY.md) — 무인카페 인수 전략과 100점 평가 체크리스트. **매물 링크를 주며 "분석해줘"라고 하면 이 문서 기준으로 평가한다.** 핵심 전제: 빈 상가가 아니라 **기존 카페 양도 매물**(시설 완비)을 싸게 인수해 무인화. 배점 100점 중 약 65점(유동·노출·경쟁)은 현장에서만 확인 가능하므로, 사전 분석은 "현장 갈 후보 추리기"까지가 역할이다.
