...
**2026-08-21 가동 개시** — 원격: https://github.com/seungwan-seo/coffe-alert (public, 폴더명과 다름). GitHub Actions 10분 cron. 봇이 `state/seen.json`을 자동 커밋하므로 **로컬 수정 전 `git pull` 필수**. 알림 수신: 텔레그램 그룹(사용자+동업자).
